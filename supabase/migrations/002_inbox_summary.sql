-- Run this after 001_shipcheck.sql if the first migration was already installed.
-- It prevents the inbox from downloading full field evidence for all emails.
