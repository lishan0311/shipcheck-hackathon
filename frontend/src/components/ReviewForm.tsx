...
export default function ReviewForm({run,onSaved}:{run:Run;onSaved:()=>Promise<void>}) {
  ...
  return <form onSubmit={submit} className="review-form">
    ...
    <fieldset disabled={busy}>
      ...
      <div className="review-footer"><p>Cases that need sender input will move to Ready to contact.</p><button className="primary" type="submit">{busy?'Saving...':'Save decision'}</button></div>
    </fieldset>
  </form>;
}
