...
export interface ValidationMetrics {available:boolean;model_accuracy?:number;model_macro_f1?:number;pipeline_accuracy?:number;pipeline_macro_f1?:number;field_f1?:number;end_to_end?:number;review_precision?:number;review_recall?:number;review_f1?:number;final_score?:number;email_count?:number;source?:string}
